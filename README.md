...
Migratsiyalar `migrate` servisi orqali versiya tartibida avtomatik qo'llanadi;
API faqat ular muvaffaqiyatli tugagandan keyin ishga tushadi.

→ **https://localhost:6443** · `admin` / `admin123`

`http://localhost:6080` avtomatik `https://localhost:6443` ga yo'naltiriladi.
Sertifikat ichki CA'dan (Let's Encrypt
